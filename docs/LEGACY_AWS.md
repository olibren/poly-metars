# Legacy AWS deployment — rollback reference only

The Cloudflare deployment is described in OPERATIONS.md. These instructions describe
the previous deployment and must not be used for routine releases.
