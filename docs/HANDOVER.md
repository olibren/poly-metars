...
an explicit finalization and dispute policy; the current code intentionally keeps
days provisional. Freeze/version the applicable policy before the market opens.
